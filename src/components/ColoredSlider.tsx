...
// 기온 (0~40°C, 범위 40) — 10~22°C 최적, 양쪽으로 갈수록 나빠짐
export const TEMP_STOPS: ColorStop[] = [
  { pct: 0,    rgb: [255, 154, 60]  }, // 0°C  — 주황 (한파)
  { pct: 12.5, rgb: [255, 217, 61]  }, // 5°C  — 노랑
  { pct: 25,   rgb: [0,   229, 160] }, // 10°C — 초록 (최적 구간 시작)
  { pct: 55,   rgb: [168, 224, 99]  }, // 22°C — 연두 (최적 구간 끝)
  { pct: 70,   rgb: [255, 217, 61]  }, // 28°C — 노랑
  { pct: 82.5, rgb: [255, 154, 60]  }, // 33°C — 주황
  { pct: 100,  rgb: [255, 71,  87]  }, // 40°C — 빨강
];

// 습도 (15~100%, 범위 85) — 30~70% 최적, 양쪽으로 갈수록 나빠짐
export const HUM_STOPS: ColorStop[] = [
  { pct: 0,    rgb: [255, 154, 60]  }, // 15%  — 주황 (건조 주의)
  { pct: 17.6, rgb: [0,   229, 160] }, // 30%  — 초록 (최적 구간 시작)
  { pct: 64.7, rgb: [168, 224, 99]  }, // 70%  — 연두 (최적 구간 끝)
  { pct: 82.4, rgb: [255, 154, 60]  }, // 85%  — 주황 (페널티 시작)
  { pct: 100,  rgb: [255, 71,  87]  }, // 100% — 빨강
];
