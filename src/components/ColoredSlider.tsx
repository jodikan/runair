...
export const TEMP_STOPS: ColorStop[] = [
  { pct: 0,    rgb: [255, 154, 60]  }, // 0°C  — 나쁨 (근육 경직)
  { pct: 12.5, rgb: [255, 217, 61]  }, // 5°C  — 보통
  { pct: 25,   rgb: [0,   229, 160] }, // 10°C — 최적 구간 시작
  { pct: 40,   rgb: [0,   229, 160] }, // 16°C — 순수 초록 끝, 서서히 노랑으로
  { pct: 70,   rgb: [255, 217, 61]  }, // 28°C — 보통 (노랑)
  { pct: 82.5, rgb: [255, 154, 60]  }, // 33°C — 나쁨
  { pct: 100,  rgb: [255, 71,  87]  }, // 40°C — 매우나쁨
];
